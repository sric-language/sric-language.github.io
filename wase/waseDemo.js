...
// include: C:\Users\YANGJI~1\AppData\Local\Temp\tmpxsm1wlc7.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'C:/Users/yangjiandong/fmakeRepo/emcc/waseDemo-1.0-release/bin/waseDemo.data';
      var REMOTE_PACKAGE_BASE = 'waseDemo.data';
...
Module['FS_createPath']("/", "res", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_C:/Users/yangjiandong/fmakeRepo/emcc/waseDemo-1.0-release/bin/waseDemo.data');

      };
      Module['addRunDependency']('datafile_C:/Users/yangjiandong/fmakeRepo/emcc/waseDemo-1.0-release/bin/waseDemo.data');
    ...
    loadPackage({"files": [{"filename": "/res/Roboto-Regular.ttf", "start": 0, "end": 145348}, {"filename": "/res/image.png", "start": 145348, "end": 156564}, {"filename": "/res/style.himl", "start": 156564, "end": 156632}, {"filename": "/res/view.himl", "start": 156632, "end": 156865}], "remote_package_size": 156865});

  })();

// end include: C:\Users\YANGJI~1\AppData\Local\Temp\tmpxsm1wlc7.js
// include: C:\Users\YANGJI~1\AppData\Local\Temp\tmpc2t1cif5.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\YANGJI~1\AppData\Local\Temp\tmpc2t1cif5.js
// include: C:\Users\YANGJI~1\AppData\Local\Temp\tmpg78t4jdf.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\YANGJI~1\AppData\Local\Temp\tmpg78t4jdf.js
...
var ASM_CONSTS = {
  131655: () => { alert('Your browser does not support WebGL 2.0'); }
};
...
// end include: preamble.js
  ...
  function _editTextCreate(inputType, text, textBox) {
  ...
  function _editTextUpdate(x, y, w, h, fontSize) {
        var elem = this._editText;
        if (!elem) return;
  ...
  function _fontKerning(uniChar, fontName, bold, fontSize, previous) {
  ...
  function _fontMerics(uniChar, fontName, bold, fontSize, out) {
  ...
  function _fontRender(uniChar, fontName, bold, fontSize, out) {
...
var wasmImports = {
  ...
  /** @export */
  editTextCreate: _editTextCreate,
  /** @export */
  editTextRemove: _editTextRemove,
  /** @export */
  editTextUpdate: _editTextUpdate,
  /** @export */
...
var _editTextOnTextChange = Module['_editTextOnTextChange'] = createExportWrapper('editTextOnTextChange', 2);
